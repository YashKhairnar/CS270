...
def plot_confusion_matrix(y_true, y_pred, class_names):
    ...
    plt.tight_layout()
    plt.savefig('svm_gridsearch_confusion_matrix.png')
    plt.close()
    print("Confusion matrix saved to svm_gridsearch_confusion_matrix.png")
...
def plot_results_comparison(results):
    ...
    plt.tight_layout()
    plt.savefig('svm_gridsearch_hyperparameter_comparison.png')
    plt.close()
    print("Hyperparameter comparison saved to 'svm_gridsearch_hyperparameter_comparison.png'")
...
if __name__ == '__main__':
    ...
    best_svm, best_config = train_svm_with_grid_search(
    ...
    with open('svm_gridsearch_model.pkl', 'wb') as f:
        pickle.dump(best_svm, f)
    with open('scaler_gridsearch.pkl', 'wb') as f:
        pickle.dump(scaler, f)
    print("Model saved to svm_gridsearch_model.pkl")
    print("Scaler saved to scaler_gridsearch.pkl")
    ...
    import json
    with open('svm_gridsearch_results.json', 'w') as f:
        json.dump(summary, f, indent=4)
    print("Results saved to 'svm_gridsearch_results.json'")
